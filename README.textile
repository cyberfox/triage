...
database.  It's not fast, but it _tries_ to keep in sync with Lighthouse,
so it probably won't ever be.
...
tickets.  The next step is handling stepping one at a time through
search results.
